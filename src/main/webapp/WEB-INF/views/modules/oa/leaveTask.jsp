...
<head>
	...
	<link rel="stylesheet" href="${ctxStatic}/customized/oa.css" />
					...
					$.getJSON("${ctx}/oa/leave/detail/" + leaveId , function(data){
						 ...
						 top.$.jBox(html, { title: "流程办理["+obj.data("tname") + "]",buttons:{"同意":"yes","驳回":"no","取消":"cancel"},submit: function (v, h, f) {
							...
							//驳回
								 ...
								 top.$.jBox("<div class='divPadding'><textarea id='leaderBackReason' class='leaderBackReason'></textarea></div>", { title: "请填写驳回理由", submit: function () {
					...
					$.getJSON("${ctx}/oa/leave/detail/" + leaveId , function(data){
						 ...
						 top.$.jBox(html, { title: "流程办理["+obj.data("tname") + "]",buttons:{"同意":"yes","驳回":"no","取消":"cancel"},submit: function (v, h, f) {
							 ...
							 //驳回
								 ...
								 top.$.jBox("<div class='divPadding'><textarea id='hrBackReason' class='hrBackReason'></textarea></div>", { title: "请填写驳回理由", submit: function () {
