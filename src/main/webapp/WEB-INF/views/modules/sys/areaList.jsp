                ...
                beforeExpand : function($treeTable, id) {
                    $.ajax({
                        ...
                        success: function (data) {
                            ...
                            $("#treeTableList2").empty();
                            var tp2 = $("#treeTableTp2").html().replace(/(\/\/\<!\-\-)|(\/\/\-\->)/g,"");
                            addRow("#treeTableList2", tp2, data, id, true);
                            $treeTable.addChilds($("#treeTableList2").html());
                        }
                    });
                }
			});
...
<body>
    ...
    <script type="text/template" id="treeTableTp2">
