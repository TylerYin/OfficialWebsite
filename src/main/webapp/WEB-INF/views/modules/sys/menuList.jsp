...
<body>
	...
	<form id="listForm" method="post">
		<table id="treeTable" class="table table-striped table-bordered table-condensed hide">
			<thead><tr><th>名称</th><th>链接</th><th class="textAlignCenter">排序</th><th>可见</th><th>权限标识</th><shiro:hasPermission name="sys:menu:edit"><th>操作</th></shiro:hasPermission></tr></thead>
				...
				<tr id="${menu.id}" pId="${menu.parent.id ne '1'?menu.parent.id:'0'}">
					...
					<td class="textAlignCenter">
						<shiro:hasPermission name="sys:menu:edit">
							...
							<input name="sorts" type="text" value="${menu.sort}" class="inputStyle">
