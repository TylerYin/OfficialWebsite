...
<body>
    ...
    <div id="getOfficeCodeURL" class="hidden">${ctx}/sys/office/getOfficeCode</div>
	<form:form id="inputForm" modelAttribute="office" action="${ctx}/sys/office/save" method="post" class="form-horizontal">
		...
		<div class="control-group">
			...
			<div class="controls">
                <sys:treeselect id="office" name="parent.id" isOfficeForm="true" value="${office.parent.id}" labelName="parent.name" labelValue="${office.parent.name}"
		...
		<div class="control-group">
			...
			<div class="controls">
				<form:input path="code" readonly="true" htmlEscape="false" maxlength="50"/>
			</div>
		</div>
		<div class="control-group">
        ...
        <div class="control-group">
            ...
            <div class="controls">
                <form:input path="website" htmlEscape="false" maxlength="80"/>
            </div>
        </div>
        <div class="control-group">
            <label class="control-label">公司简介：</label>
            <div class="controls">
                <form:textarea path="summary" htmlEscape="false" rows="4" maxlength="166" class="input-xxlarge "/>
                <sys:ckeditor replace="summary" uploadPath="/companyInfo" />
            </div>
        </div>
		<div class="control-group">
