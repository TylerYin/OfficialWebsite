...
<head>
	...
	<script type="text/javascript">
		$(document).ready(function() {
			...
			var data = ${fns:toJson(list)}, rootId = "${office.type eq '1' ? (not empty office.id ? office.id : '0') : (not empty office.parentId ? office.parentId : '0')}";
            addParent("#treeTableList", tpl, data, rootId, true);
			addRow("#treeTableList", tpl, data, rootId, true);
			$("#treeTable").treeTable({expandLevel : 5});
		});

        function addParent(list, tpl, data, pid, root) {
