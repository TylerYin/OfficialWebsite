...
FW.location = {
    bindAll: function () {
        ...
        this.Events.loadZSURL();
        this.Events.loadFWURL();
    },
    ...
    Events: {
        ...
        loadZSURL : function () {
            $('#locateToZSURL').click(function(){
                window.location.href = $('#zsURL').text() + "?qrCode=" + $('#qrCode').val();
            });
        },

        loadFWURL : function () {
            $('#locateToFWURL').click(function(){
                window.location.href = $('#fwURL').text() + "?qrCode=" + $('#qrCode').val();
            });
        }
    }
};
