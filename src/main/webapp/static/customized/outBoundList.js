        ...
        btnDeleteClick: function () {
            $('#btnDelete').click(function () {
                ...
                $("#contentBody").find(":checkbox").each(function () {
                    if ($(this).is(":checked")) {
                        if (outBoundIds == "") {
                            outBoundIds += $(this).parent().find("span").html();
                        }
                        else {
                            outBoundIds += "," + $(this).parent().find("span").html();
                        }
                ...
                if (outBoundIds.length > 0) {
                    return confirmx('确认要删除该出库计划吗？', 'javascript:OutBoundList.Events.deletePlans();');
                }
                else {
                    showTip("请选择需要删除的数据！");
                }
