...
public class CommentController extends BaseController {
    ...
    public String delete(Comment comment, @RequestParam(required = false) String status, RedirectAttributes redirectAttributes) {
        commentService.delete(comment, status);
        String message;
        ...
        return "redirect:" + adminPath + "/cms/comment/?repage&delFlag=" + status;
    }
