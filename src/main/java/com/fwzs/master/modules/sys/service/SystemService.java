...
import com.fwzs.master.common.security.Digests;
import com.fwzs.master.common.security.shiro.session.SessionDAO;
import com.fwzs.master.common.service.BaseService;
import com.fwzs.master.common.service.ServiceException;
import com.fwzs.master.common.utils.CacheUtils;
import com.fwzs.master.common.utils.Encodes;
import com.fwzs.master.common.utils.StringUtils;
import com.fwzs.master.common.web.Servlets;
import com.fwzs.master.modules.sys.dao.MenuDao;
import com.fwzs.master.modules.sys.dao.RoleDao;
import com.fwzs.master.modules.sys.dao.UserDao;
import com.fwzs.master.modules.sys.entity.Menu;
...
import com.fwzs.master.modules.sys.security.SystemAuthorizingRealm;
import com.fwzs.master.modules.sys.utils.LogUtils;
...
public class SystemService extends BaseService implements InitializingBean {
    ...
    /**
     * 根据登录用户名和所属公司查询是否存在指定用户
     *
     * @param loginName
     * @param company
     * @return
     */
    public boolean isUserAccountExist(final String loginName, final Office company) {
        List<User> users = getByLoginNameAndCompany(loginName, company);
        return CollectionUtils.isNotEmpty(users) ? true : false;
    }
     ...
     * @return
     */
    public List<User> getByLoginNameAndCompany(final String loginName, final Office company) {
        User user = new User();
        user.setLoginName(loginName);
        user.setCompany(company);
        return userDao.getByLoginNameAndCompany(user);
    }
...
//		systemRealm.clearAllCachedAuthorizationInfo();
     ...
     */
    @Transactional(readOnly = false)
	public void updateFullUserInfo(User user){
	    userDao.update(user);
    }
     ...
     * @return
     */
    public int deleteRoleByCompany(Role role) {
        return roleDao.deleteRoleByCompany(role);
    }
     ...
     * @return
     */
    public int deleteUserByCompany(User user) {
        return userDao.deleteUserByCompany(user);
    }
}
