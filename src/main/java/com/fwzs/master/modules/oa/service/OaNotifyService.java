 ...
 * 
 */
package com.fwzs.master.modules.oa.service;
...
import com.fwzs.master.modules.oa.dao.OaNotifyDao;
import com.fwzs.master.modules.oa.dao.OaNotifyRecordDao;
import com.fwzs.master.modules.oa.entity.OaNotify;
...
public class OaNotifyService extends CrudService<OaNotifyDao, OaNotify> {
	...
	public Page<OaNotify> find(Page<OaNotify> page, OaNotify oaNotify) {
		oaNotify.getSqlMap().put("dsf", dataScopeFilter(oaNotify.getCurrentUser(), "o", "a"));
